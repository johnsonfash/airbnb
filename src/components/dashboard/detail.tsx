...
import { faArrowUpFromBracket, faBath, faBed, faBriefcase, faCalendarXmark, faCameraRetro, faCar, faDumpsterFire, faInfoCircle, faPersonCircleCheck, faPersonShelter, faPersonWalkingLuggage, faShield, faShower, faStar, faTv, faWifi, faXmark } from "@fortawesome/free-solid-svg-icons";
...
function Detail({ open, toggle }: { open: boolean, toggle?: () => void }) {
  ...
  return <div className={`${display ? 'start-0' : ''}  w-100 d-flex z-index-3 detail-panel top-0 bottom-0 position-fixed`}>
    <div className="h-100 w-25 text-end p-4">
      <button onClick={toggle} className="btn btn-light rounded-circle">
        ...
        <div className="w-60">
          ...
          <div className="d-flex border-bottom pb-5 gap-4 pt-2 my-4 justify-content-between align-items-center">
            <div className="w-33">
              ...
              <div className="text-muted">A private room with wifi that's well-suited for working.</div>
            </div>
            <div className="w-33">
              <div className="display-7 min-w-4 min-h-4 d-inline-flex justify-content-center align-items-center rounded-circle text-danger bg-danger bg-opacity-10">
              ...
              <div className="text-muted">Check yourself in with the keypad.</div>
            </div>
            <div className="w-33">
              <div className="display-7 min-w-4 min-h-4 d-inline-flex justify-content-center align-items-center rounded-circle text-danger bg-danger bg-opacity-10">
          ...
          <div className="py-3">
            ...
            <div className="text-muted">
              Enjoy a quiet getaway in this charming cottage renovated, designed and owned by Chip and Joanna Gaines. Originally the carriage house for Hillcrest Estate, this home includes one bathroom, one bath, an office nook and a private back patio. This makes it the perfect getaway  for a party of two, or if you're stopping through town and need a restful place to retreat.
            </div>
          ...
          <div className="py-4 border-bottom">
            ...
            <div className="d-flex mb-3 justify-content-between align-items-center">
              ...
              <div className="col-4">
                <FontAwesomeIcon icon={faPersonWalkingLuggage} />
                <span className="d-inline-block ms-2">Private patio or balcony</span>
              </div>
              <div className="col-4">
                <FontAwesomeIcon icon={faPersonWalkingLuggage} />
                <span className="d-inline-block ms-2">Centrail air conditioning</span>
              </div>
            </div>
            <div className="d-flex mb-3 justify-content-between align-items-center">
              <div className="col-4">
                <FontAwesomeIcon icon={faBriefcase} />
                <span className="d-inline-block ms-2">Dedicated workspace</span>
              </div>
              <div className="col-4">
            ...
            <div className="d-flex mb-3 justify-content-between align-items-center">
              <div className="col-4">
                ...
                <span className="d-inline-block ms-2">Free dryer - in unit</span>
              </div>
              <div className="col-4">
                <FontAwesomeIcon icon={faShower} />
                <span className="d-inline-block ms-2">Free washer - in unit</span>
              </div>
              <div className="col-4">
                <FontAwesomeIcon icon={faShower} />
          ...
          <div className="py-4 border-bottom">
            ...
            <div className="p-4 border rounded-4">
              ...
              <div className="d-flex mb-3 align-items-center">
                <div className="no-break w-25 d-inline-block">Communication</div>
                <div className="w-75 range-bar rounded-2 position-relative border">
                  ...
                  <div className="w-50 p-2" key={i}>
                    <div className="p-3 border rounded-4">
                      <div className="d-flex mb-4">
                        <div className="max-w-3 me-3 min-h-3 border rounded-circle overflow-hidden"><img src={user} alt="" /></div>
                        <div>
                      ...
                      <div>
                        Abbes's place was so wonderful and just what i needed. It was the perfect escape with a great wood stove, beautiful views, horses and nearby skiing. I'm so greateful.
                      </div>
                    </div>
                  </div>
                )
          ...
          <div className="py-4 border-bottom">
            ...
            <iframe className="overflow-hidden rounded-4 my-4" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31704.367470642122!2d3.4976001682787685!3d6.64121839265256!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103beeb0ae5ff3cf%3A0x60f7cb2450a5e356!2sAgbala%2C%20Ikorodu%20104101%2C%20Ikorodu%2C%20Lagos!5e0!3m2!1sen!2sng!4v1684982006666!5m2!1sen!2sng" width="100%" height="450" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            <h5 className="fw-bold">Whitefish, Montana, United States</h5>
            <div className="text-muted">The property, given its close proximity in the refreshing hillside of Tagaytay and clear blue beaches of Nesugbu, provides a quick escape from the hustle and bustle of city life.</div>
          ...
          <div className="py-4 border-bottom">
            ...
            <div className="d-flex my-4 justify-content-between align-items-center">
              <div className="d-flex align-items-center">
                <div className="max-w-3 rounded-circle overflow-hidden me-3"><img src={user} alt="" /></div>
                <div>
                  <h5 className="my-0">Hosted by Brenda</h5>
                  <small className="text-muted">Joined in August 2014</small>
                </div>
              </div>
              <button className="btn border py-2 rounded-4 border-3">Contact Host</button>
            </div>
            ...
            <div className="text-muted">As a memeber of 4, living in Solana Beach for 25+ years, i love to help families enjoy our beautiful area. Vacations are special and we do our very best to make them affordable, enjoy...</div>
            <div className="my-4 text-danger d-inline-block">View more</div>
          </div>
          ...
          <div className="sticky-top">
            <div className="p-4 bg-light rounded-4">
              <div className="d-flex mb-3 align-items-center justify-content-between">
                <div className="d-flex align-items-center">
                  <h4 className="my-0 fw-bold">$10,000</h4> <span className="d-inline-block ms-1">/ night</span>
                </div>
                <div>
                  <FontAwesomeIcon icon={faStar} />
              ...
              <div className="d-flex mt-5 mb-2 justify-content-between">
                <div className="fw-bold">6 nights <FontAwesomeIcon icon={faInfoCircle} /></div>
                <div>$2,199</div>
              </div>
              <div className="d-flex mb-2 justify-content-between">
                <div className="fw-bold">Cleaning fee <FontAwesomeIcon icon={faInfoCircle} /></div>
                <div>$85</div>
              </div>
              <div className="d-flex justify-content-between">
                <div className="fw-bold">Airbnb service fee <FontAwesomeIcon icon={faInfoCircle} /></div>
                <div>$222</div>
              </div>
              ...
              <button className="btn mt-4 rounded-4 py-2 btn-danger w-100">Reserve</button>
            </div>
            <div className="p-4 mt-3 bg-light rounded-4 d-flex gap-4">
              <FontAwesomeIcon icon={faGem} className='display-5 text-danger' />
              <div>
